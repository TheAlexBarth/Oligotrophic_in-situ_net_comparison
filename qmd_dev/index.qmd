...
-   [4: Regression between bin-matched UVP and MOCNESS density estimates](./main_analysis_04.html)
-   [5: Depth Integrated Abundance](./main_analysis_05.html)
-   [6: Biomass profiles estimated by the two different tools](./main_analysis_06)
-   [7: Regression between bin-matched UVP and MOCNESS biomass estimates](./main_analysis_07.html)
-   [8: Depth Integrated Biomass](./main_analysis_08.html)
